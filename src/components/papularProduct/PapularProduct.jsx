...
function PapularProduct({addTOCart}) {
 ...
 <div>
    ...
    {papularData.sort().slice(papularData.length-4).map((item,index)=>(
        <div className="card shadow mt-3" style={{width: "24rem"}} key={item.id}>
  ...
  <div className="card-body">
    ...
    <div className="row">
        ...
        <div className="col-md-12 col-12 my-3"><button className='btn form-control btn-primary' onClick={()=>addTOCart(item)}>Add to cart</button></div>
      </div>
